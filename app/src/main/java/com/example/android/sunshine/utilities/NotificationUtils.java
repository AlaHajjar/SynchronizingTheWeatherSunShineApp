 ...
 */
    private  final static int NOTIFICATION_IDINTIFY = 1;
...
//          TODO (2) Use NotificationCompat.Builder to begin building the notification
             ...
             * forecast.
             */
            NotificationCompat.Builder notiBulder = new NotificationCompat.Builder(context)
...
//          TODO (3) Create an Intent with the proper URI to start the DetailActivity
             ...
             */
            Intent displaydate = new Intent(context, DetailActivity.class);
            displaydate.setData(todaysWeatherUri);
            //    TODO (4) Use TaskStackBuilder to create the proper PendingIntent
            TaskStackBuilder taskStackBuilder =  TaskStackBuilder.create(context);
           taskStackBuilder.addNextIntentWithParentStack(displaydate);
            PendingIntent resultPendingIntent = taskStackBuilder.getPendingIntent(0,PendingIntent.FLAG_UPDATE_CURRENT);

//          TODO (5) Set the content Intent of the NotificationBuilder
            notiBulder.setContentIntent(resultPendingIntent);
//          TODO (6) Get a reference to the NotificationManager
            NotificationManager noitifManager = (NotificationManager) context.getSystemService(Context.NOTIFICATION_SERVICE);
//          TODO (7) Notify the user with the ID WEATHER_NOTIFICATION_ID
             noitifManager.notify(NOTIFICATION_IDINTIFY,notiBulder.build());
