...
public final class SunshinePreferences {
    ...
    public static boolean areNotificationEnabled(Context context) {
        ...
        String checkBoxKey  = context.getString(R.string.pref_enable_notifications_key);
        /*
         ...
         */
        boolean checkBoxDefaultVAlue = context.getResources().getBoolean(R.bool.show_notification_default_value);
        /* As usual, we use the default SharedPreferences to access the user's preferences */
        SharedPreferences sp= PreferenceManager.getDefaultSharedPreferences(context);

        /* If a value is stored with the key, we extract it here. If not, use a default. */
        boolean shouldDisplayNotification=sp.getBoolean(checkBoxKey,checkBoxDefaultVAlue);
